...
private:
    ...
    int arraytinyright[4] = {static_cast<int>(45 * batterymultiplier), 1, static_cast<int>(10 * batterymultiplier), 1};
    ...
    int arraytinyleft[4] = {static_cast<int>(10 * batterymultiplier), 1, static_cast<int>(45 * batterymultiplier), 1};
