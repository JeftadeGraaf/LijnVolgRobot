...
private:
    ...
    int arraytinyright[4] = {static_cast<int>(100 * batterymultiplier), 1, static_cast<int>(75 * batterymultiplier), 1};
    int arraybigright[4] = {static_cast<int>(60 * batterymultiplier), 1, static_cast<int>(40 * batterymultiplier), 1};
    int arrayahead[4] = {static_cast<int>(100 * batterymultiplier), 1, static_cast<int>(100 * batterymultiplier), 1};
    int arraytinyleft[4] = {static_cast<int>(75 * batterymultiplier), 1, static_cast<int>(100 * batterymultiplier), 1};
    int arraybigleft[4] = {static_cast<int>(40 * batterymultiplier), 1, static_cast<int>(60 * batterymultiplier), 1};
